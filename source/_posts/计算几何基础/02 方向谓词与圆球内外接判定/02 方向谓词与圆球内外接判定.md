...
tags:
  ...
  - 几何判定
  - Delaunay
description: Day 02 主要学习二维和三维方向谓词，以及点相对外接圆和外接球的内外接判定。核心思路是使用具有明确符号意义的几何谓词表达空间关系，并结合行列式和稳健数值判断减少浮点误差带来的误判。
excerpt: Day 02 主要学习二维和三维方向谓词，以及点相对外接圆和外接球的内外接判定。核心思路是使用具有明确符号意义的几何谓词表达空间关系，并结合行列式和稳健数值判断减少浮点误差带来的误判。
---
