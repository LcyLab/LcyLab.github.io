...
tags:
  ...
  - Maxwell方程组
  - 电磁仿真
description: Day 02 主要学习有限差分和时域有限差分方法（FDTD）。核心思路是把连续空间和时间离散化，用相邻网格点的场值近似导数，再按照麦克斯韦方程组逐时间步更新电场和磁场。
excerpt: Day 02 主要学习有限差分和时域有限差分方法（FDTD）。核心思路是把连续空间和时间离散化，用相邻网格点的场值近似导数，再按照麦克斯韦方程组逐时间步更新电场和磁场。
---
