...
tags:
  ...
  - 电磁介质
  - 麦克斯韦方程组
description: 整理电荷、电流、电场、电位移、磁场、导体电导率和麦克斯韦方程组等基础概念。
---

> 本文根据照片中能够辨认的深色、蓝色和红色笔迹整理，不是逐字转录。公式符号做了统一，便于在 Typora 和 Hexo 中阅读与渲染。
>
> 照片底部的浅灰色透字和部分模糊批注无法可靠辨认，未将其作为确定内容录入；正文中的教材化解释属于整理说明，不代表照片中的原句。
...
> 注：照片中这一行的下标较淡，这里按电磁学中的标准写法整理为 $\varepsilon_0$；线性介质关系再写为 $\mathbf{D}=\varepsilon\mathbf{E}$。
